...
| [DynamoDB](docs/dynamodb.md) | Table/index metadata, replicas, typed items, bounded Scan/Query/GetItem, backup/import/export inspection, Streams/shards/records, sequence replay and following | Batch/transactional reads, PartiQL; writes and administration |

...
#[command(
    version,
    about,
    long_about = "OneTUI database browser. Browse PostgreSQL rows and schema/relation/column metadata, or Qdrant collections and points with payloads and vectors loaded on demand. Check connectivity without a terminal, or dump the offline capability catalog. Filter and sort the displayed page locally."
)]
struct Args {
    #[command(subcommand)]

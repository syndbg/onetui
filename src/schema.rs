...
pub fn dump(datasource: Option<&str>) -> Result<String> {
    ...
    Ok(serde_json::to_string_pretty(&serde_json::json!({
        ...
        "browsing_limits": {"metadata_page_rows": 100, "retained_pages_per_view": 3, "page_bytes": 1048576,
            "notes": "Fixed limits, not TOML settings or an RSS guarantee; offset metadata pages do not provide a cross-request snapshot"}
    }))?)
}

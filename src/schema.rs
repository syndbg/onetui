...
pub fn dump<P: Provider>(catalog: &[P], datasource: Option<&str>) -> Result<String> {
    ...
    Ok(serde_json::to_string_pretty(&serde_json::json!({
        ...
        "configuration": {
            "format": "TOML; optional theme string and display table, required connections table. Every entry is validated, including unselected aliases; unknown themes/kinds/fields, invalid reference names, relative PostgreSQL CA paths and invalid Qdrant URLs are rejected.",

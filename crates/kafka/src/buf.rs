...
pub(crate) fn capabilities() -> serde_json::Value {
    serde_json::json!({
        ...
        "fields": {
            ...
            "token_env": {"required": false, "default": "anonymous", "type": "ASCII environment-variable name", "purpose": "Buf Bearer token, independent of Kafka and other bindings; 1..4096 UTF-8 bytes without controls, resolved only for the selected alias."},

...
fn capabilities() -> serde_json::Value {
    serde_json::json!({
        ...
        "unsupported": ["global timestamp ordering", "cross-topic browsing", "publishing from the app", "consumer-group administration", "schema registry", "client TLS certificates", "OAuth", "GSSAPI"]
    })
}
